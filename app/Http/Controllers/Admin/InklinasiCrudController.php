...
use App\Http\Requests\StoreInklinasiRequest as StoreRequest;
use App\Http\Requests\UpdateInklinasiRequest as UpdateRequest;

/**
 * Class InklinasiCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class InklinasiCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Inklinasi');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/inklinasi');
        $this->crud->setEntityNameStrings('inklinasi', 'inklinasis');
        ...
        */
        ...
        // add asterisk for fields that are required in InklinasiRequest
