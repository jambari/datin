 ...
 */
class GempanganjukCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Gempanganjuk');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/gempanganjuk');
        $this->crud->setEntityNameStrings('gempanganjuk', 'gempanganjuk');
        ...
        */
        ...
        if (backpack_auth()->user()->name == 'angkasa') {
            $this->crud->allowAccess(['list', 'infonganjuk','reorder','press']);
      } 

        $this->crud->allowAccess(['list','infonganjuk', 'create', 'update', 'reorder', 'delete','press']);     
        $this->crud->addButtonFromView('line', 'infonganjuk' , 'infonganjuk', 'beginning');
...
public function infonganjuk($id) {
