...
use App\Http\Requests\MagnetRequest as StoreRequest;
use App\Http\Requests\MagnetRequest as UpdateRequest;

/**
 * Class MagnetCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class MagnetCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Magnet');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/magnet');
        $this->crud->setEntityNameStrings('magnet', 'magnets');
        ...
        */
        ...
        // add asterisk for fields that are required in MagnetRequest
