...
class CityCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setEntityNameStrings('Kota', 'Kota-kota');
...
// add a single column, at the end of the stack
        $this->crud->addColumns(['latitude', 'longitude', 'name']); // add multiple columns, at the end of the stack
        // $this->crud->removeColumn('column_name'); // remove a column from the stack
        // $this->crud->removeColumns(['column_name_1', 'column_name_2']); // remove an array of columns from the stack
        $this->crud->setColumnDetails('latitude', ['label' => 'Lintang']); // adjusts the properties of the passed in column (by name)
        $this->crud->setColumnDetails('longitude', ['label' => 'Bujur']);
        $this->crud->setColumnDetails('name', ['label' => 'Nama Kota']);
