...
use App\Http\Requests\StoreAbsolutRequest as UpdateRequest;

/**
 * Class AbsolutCrudController
...
class AbsolutCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/absolut');
        $this->crud->setEntityNameStrings('absolut', 'absoluts');
        ...
        */
        ...
        // add asterisk for fields that are required in AbsolutRequest
        ...
        $this->crud->setColumnDetails('pengamat', ['label' => 'Pengamat']);
        // ------ CRUD BUTTONS
