                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2" id="balai" >
                            <div id="streetmap-baru">
                                ...
                                <p class="text-center " style="" > <strong class="" >Info Gempa Mag:{{ $mag }}, {{ $tanggalindosms }} {{ $jamwit }} WIT, Lok:{{ $lat }}, {{ $lon }} ({{ $event['ket'] ?? '-' }}), Kedlmn:{{ $event['depth'] }} Km @if($event->terasa), dirasakan {{ $event->terdampak }} @endif ::BMKG-PGR-V</strong> </p>
                            </div>
                        </div>
                    </div>
                </div>
