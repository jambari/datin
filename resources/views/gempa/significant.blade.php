                    ...
                    <div class="row">
                        <div class="col-md-12" id="balai" >
                            <div id="streetmap-baru">
                                ...
                                <p class="text-center " style="" > <strong class="" >Info Gempa Mag: {{ $event->magnitudo }} SR, {{ $event->tanggal }} {{ $event->jam }} WIT, Lok: {{ $lat }}-{{ $lon }} BT ({{ $event->lokasi }}), Kdlmn: {{ $event->depth }} Km @if($event->dirasakan), dirasakan {{ $event->dirasakan }} @endif :: BMKG </strong> </p>
                            </div>
                        </div>
                    </div>
                </div>
 ...
 function changeKota(kota){
    var kota = kota.value;
      if (kota === 'NyalakanKota') {
        ...
        L.marker([{{ $event->lintang }}, {{ $lon }}], {icon: eqIcon}).addTo(mymap);
    ...
    L.marker([{{ $event->lintang }}, {{ $lon }}], {icon: pulsingIcon}).addTo(mymap);
    L.marker([{{ $event->lintang }}, {{ $lon }}], {icon: whiteIcon}).addTo(mymap);
    // KOta di Papua
