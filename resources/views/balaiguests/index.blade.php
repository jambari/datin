...
@endsection
@section('content')
@include('balaiguests.pesan')
<div class="container" style="margin-top: 3%;">
        <form action="/balaiguests/search" method="POST" role="search">
            {{ csrf_field() }}
        ...
        <div class="col-md-12">
            <div class="container" style="margin-top: 3%;">
                ...
                <div class="row" style="margin-top: 3%;">
                    ...
                    <!-- <a href="{{ route('balaiguests.show',$guest->id) }}"> -->
                    ...
                    <div class="card" style="width: 18rem;">
                      ...
                      <div class="card-body">
                        ...
                        <!-- <form action="{{ route('balaiguests.destroy',$guest->id) }}" method="POST">
                        <a class="btn btn-primary" href="{{ route('balaiguests.edit',$guest->id) }}">Edit</a>
                        @csrf
                        @method('DELETE')
