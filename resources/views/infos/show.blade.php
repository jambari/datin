...
<div class="row">
    <div class="col-md-12">
    <a href="/admin/infogempa/{{ $info->id }}/edit" class="btn btn-danger btn-block">EDIT DARAT/LAUT</a>
    </div>
</div>
@endsection
...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="streetmap">
                                ...
                                <p class="text-center" style="font-size: 1.1em; margin-left:5%;margin-right:5%;" > <strong>{{ $info->sms }} </strong> </p>
   ...
   <script src="{{ asset('gjson') }}/plates.js" > </script>
    ...
    <script>
        ...
        var mymap = L.map('map').setView([{{ $info->lintang}}, {{ $info->bujur }}], 7);
        ...
        L.marker([{{ $info->lintang}}, {{ $info->bujur }}], {icon: eqIcon}).addTo(mymap);
