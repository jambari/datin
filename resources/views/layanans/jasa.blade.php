			  ...
			  <div class="row">
			    <div class="col s12 m4">
				    <div class="card">
				        ...
				        <div class="card-content">
				        	<span class="card-title red-text text-accent-3">Teropong Rukyat (low grade)</span>
			    ...
			    <div class="col s12 m4">
			      <div class="card">
			        ...
			        <div class="card-content">
			           <span class="card-title red-text text-accent-3">Digital Portable Short Period Seismograph</span>
			    ...
			    <div class="col s12 m4">
			      <div class="card">
			        ...
			        <div class="card-content">
			           <span class="card-title red-text text-accent-3">Deklinasi dan Inklinasi Magnetometer</span>
